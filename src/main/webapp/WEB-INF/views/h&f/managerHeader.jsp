...
<head>
 ...
 <!--  	<link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.2.0/css/all.css">
  ...
  <!-- data tables -->
  <link href="<c:url value='/resources/css/addons/datatables.min.css'/>" rel="stylesheet">
   <link href="<c:url value='/resources/css/addons/datatables-select.min.css'/>" rel="stylesheet">
    ...
    <nav class="navbar fixed-top navbar-toggleable-md navbar-expand-lg double-nav scrolling-navbar" style="background: linear-gradient(40deg,#ff6ec4,#7873f5) !important">
      ...
      <ul class="nav navbar-nav nav-flex-icons ml-auto">
        <li class="nav-item active">
          <a class="nav-link" href="home?mid=${id}">Home 
            <span class="sr-only">(current)</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="profile?mid=${manager.mgrId}">Profile</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="agentList?mid=${manager.mgrId}">Agent List</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="branchDetails?mid=${manager.mgrId}">Branch Details</a>
        </li>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-secondary" aria-labelledby="navbarDropdownMenuLink-555">
            ...
            <a class="dropdown-item" href="addPolicy?mid=${manager.mgrId}">Add Policy</a>
          </div>
       </li> 
         <li class="nav-item">
          	<a class="nav-link" href="approveRequests?aid=${manager.mgrId}">Approve Requests</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="addAgent?aid=${manager.mgrId}">Add Agent</a>
        </li>
        ...
        <li class="nav-item avatar dropdown">
          ...
          <a class="dropdown-item" >Hello ${manager.mgrName} </a>
            <a class="dropdown-item" href="profile?cid=${manager.mgrId}">Profile</a>
            <hr>
