    ...
    <nav class="navbar fixed-top navbar-toggleable-md navbar-expand-lg double-nav scrolling-navbar" style="background: linear-gradient(40deg,#ff6ec4,#7873f5) !important">
      ...
      <ul class="nav navbar-nav nav-flex-icons ml-auto">
        <li class="nav-item active">
          <a class="nav-link" href="home?cid=${id}">Home 
            <span class="sr-only">(current)</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="profile?aid=${id}">Profile</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="custList?aid=${id}">Customer List</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="managerDetails?aid=${id}">Manager Details</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="policyRequests?aid=${id}">Policy Requests</a>
        </li>
         <li class="nav-item">
          <a class="nav-link" href="policies">All Policies</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="addCust?aid=${id}">Add Customer</a>
        </li>
        ...
        <li class="nav-item avatar dropdown">
          ...
          <a class="dropdown-item" >Hello ${agent.agentName} </a>
            <a class="dropdown-item" href="profile?cid=${id}">Profile</a>
            <hr>
