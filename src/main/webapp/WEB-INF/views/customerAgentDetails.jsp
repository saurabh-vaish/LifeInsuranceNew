				...
				<div class="col-xl-12 col-lg-12 mb-5 mt-5 d-md-flex justify-content-between">
					<div class="avatar mb-md-0 mb-4 mx-4 col-xs-12 col-sm-4">
					 ...
					 <div class="mx-8 col-xs-12 col-sm-8">
						<h4 class="font-weight-bold mb-3">${ag.value.agentName}</h4>
						<h6 class="font-weight-bold grey-text mb-3">Branch : ${ag.value.agentBranch}</h6>
						<p class="grey-text">Age : ${ag.value.agentBranch} </p>
						<p class="grey-text">Contact : ${ag.value.agentPhone}</p>
						<p class="grey-text">Address : ${ag.value.agentAdd}</p>
						<!-- Facebook-->
