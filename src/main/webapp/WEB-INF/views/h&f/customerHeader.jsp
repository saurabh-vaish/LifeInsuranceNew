  ...
  <header>
    ...
    <nav class="navbar fixed-top navbar-toggleable-md navbar-expand-lg double-nav scrolling-navbar" style="background: linear-gradient(40deg,#ff6ec4,#7873f5) !important">
      ...
      <ul class="nav navbar-nav nav-flex-icons ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="profile?cid=${id}">Profile</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="myPolicy?cid=${customer.custId}">My Policy</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="custAgentDetails?cid=${customer.custId}">Agent Details</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="policies">Request Policy </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="history?cid=${customer.custId}">Payment History</a>
        </li>
        ...
        <li class="nav-item avatar dropdown">
          ...
          <a class="dropdown-item" >Hello ${customer.custName} </a>
            <a class="dropdown-item" href="profile?cid=${customer.custId}">Profile</a>
            <hr>
